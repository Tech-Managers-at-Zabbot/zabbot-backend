...
UserActivityLog.init({
    ...
    activityType: {
        type: sequelize_1.DataTypes.ENUM(...Object.values(users_types_1.ActivityType)),
        allowNull: false,
    },
    description: {
    ...
    level: {
        type: sequelize_1.DataTypes.ENUM(...Object.values(users_types_1.LogLevel)),
        allowNull: false,
        defaultValue: users_types_1.LogLevel.INFO,
    },
    timestamp: {
