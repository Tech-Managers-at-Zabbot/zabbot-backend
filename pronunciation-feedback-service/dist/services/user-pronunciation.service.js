...
const getPronunciations = utilities_1.errorUtilities.withServiceErrorHandling(async () => {
    const pronunciations = await user_pronunciation_repository_1.default.getPronunciations();
...
const getPronunciation = utilities_1.errorUtilities.withServiceErrorHandling(async (id) => {
    const pronunciation = await user_pronunciation_repository_1.default.getPronunciation(id);
...
const addPronunciation = utilities_1.errorUtilities.withServiceErrorHandling(async (pronunciationData) => {
    ...
    const newPronunciation = await user_pronunciation_repository_1.default.addPronunciation(newPronunciaitonData);
...
const updatePronunciation = utilities_1.errorUtilities.withServiceErrorHandling(async (id, pronunciationData) => {
    ...
    const updatedPronunciation = await user_pronunciation_repository_1.default.updatePronunciation(pronunciationData);
...
const deletePronunciation = utilities_1.errorUtilities.withServiceErrorHandling(async (id) => {
    ...
    await user_pronunciation_repository_1.default.deletePronunciation(id);
