...
export const getLessonContentsController =
...
export const getLanguageContentsController =
  errorUtilities.withControllerErrorHandling(
    async (req: Request, res: Response) => {
...
export const updateContentController =
  errorUtilities.withControllerErrorHandling(
    async (req: Request, res: Response) => {
      const { id } = req.params;
      const payload = req.body;
...
export const addContentFileController =
  errorUtilities.withControllerErrorHandling(
    async (request: Request, response: Response) => {
      const contentFileDetails = await contentService.addContentFile(
        request.body,
      );
      return responseUtilities.responseHandler(
        response,
