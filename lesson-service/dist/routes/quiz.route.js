...
router.put("/:id", validations_1.JoiValidators.inputValidator(validations_1.JoiValidators.updateQuizSchema), authorization_middleware_1.generalAuthFunction, (0, authorization_middleware_1.rolePermit)(["admin"]), controllers_1.quizController.updateQuizController);
router.delete("/:id", authorization_middleware_1.generalAuthFunction, (0, authorization_middleware_1.rolePermit)(["admin"]), controllers_1.quizController.deleteQuizController);
