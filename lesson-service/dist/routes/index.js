...
const userLesson_route_1 = __importDefault(require("./userLesson.route"));
...
rootRouter.use('/flashcards', flashcard_route_1.default);
rootRouter.use('/user-lessons', userLesson_route_1.default);
rootRouter.use('/quizzes', quiz_route_1.default);
rootRouter.use('/leaderboard', leaderboard_route_1.default);
