...
router.patch("/:id/status", authorization_middleware_1.generalAuthFunction, (0, authorization_middleware_1.rolePermit)(["admin"]), lesson_controller_1.changeLessonStatusController);
router.delete("/:id", authorization_middleware_1.generalAuthFunction, (0, authorization_middleware_1.rolePermit)(["admin"]), lesson_controller_1.deleteLessonController);
...
router.put("/change-lesson-image/:lessonId", upload.array("files", 50), authorization_middleware_1.generalAuthFunction, (0, authorization_middleware_1.rolePermit)(["admin"]), lesson_controller_1.updateLessonImageController);
